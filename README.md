...
Ce programme permet de t'initier à la programmation avec Arduino.
...
- Pour le faire fonctionner sans télécommande, que peux-tu modifier ?
- Pour le faire fonctionner avec télécommande, tu peux utiliser l'application MIT App Inventor
